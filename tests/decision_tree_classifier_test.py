...
from src.classifiers.decision_tree_classifier import setup_decision_tree_classifier
from src.classifiers.decision_tree_classifier import predict 
...
class TestDecisionTreeClassfier(unittest.TestCase):
    def setUp(self):
    ...
    def test_setup_decision_tree_classifier(self):
        """ Test Case for DecisionTreeClassfier"""
        

        model ,vec, x_testing=setup_decision_tree_classifier(self.training_data, self.training_y, self.testing_data,"text", method="count")
        
        model2 ,vec_tfidf, x_testing2=setup_decision_tree_classifier(self.training_data, self.training_y, self.testing_data,"text", method="tfidf")
        ...
        self.assertIsInstance(model, sklearn.tree.DecisionTreeClassifier)
        ...
        self.assertIsInstance(model2, sklearn.tree.DecisionTreeClassifier)
        
        
        """ Test correct behaviour for wrong method"""  
        
        self.assertTrue(setup_decision_tree_classifier(self.training_data, self.training_y, self.testing_data,"text", method="ijfsiohf"),
                        1)  
                        
    def test_predict(self):
        """ Test Case for Predict for DecisionTreeClassfier """
